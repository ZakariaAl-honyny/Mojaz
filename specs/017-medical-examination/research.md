...
- **Decision:** Use high contrast Tailwind classes driven by `hsl()` tokens configured in `globals.css` ensuring King Blue aesthetics are prevalent but not overwhelming. Forms will eschew standard borders in favor of soft shadows and structural spacing.
