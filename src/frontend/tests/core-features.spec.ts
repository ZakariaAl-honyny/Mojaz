...
test.describe('Core Features - Bilingual Platform & Theme Toggle', () => {
  ...
  test('should apply correct theme colors from DrivingLicenseIssuanceSystem branding', async ({ page }) => {
    await page.goto('/en');

    // Check if primary color from DrivingLicenseIssuanceSystem theme is applied
    // DrivingLicenseIssuanceSystem Primary: #006C35
    const html = page.locator('html');
