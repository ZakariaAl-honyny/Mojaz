      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-neutral-900 leading-tight">
            سجلات الرقابة والتدقيق
          </h1>
          <p className="text-sm font-bold text-neutral-400 mt-1">
            مراقبة كافة الحركات والعمليات المنفذة في النظام لضمان النزاهة والشفافية.
          </p>
        </div>
      </div>
                ...
                <SelectContent>
                  {ACTION_TYPES.map((type) => (
                    <SelectItem key={type.value} value={type.value}>
                      {type.value !== 'all' ? (ACTION_LABELS[type.value] || type.label) : "الكل"}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
              ...
              <Select value={entityFilter} onValueChange={setEntityFilter}>
                ...
                <SelectContent>
                  {ENTITY_TYPES.map((type) => (
                    <SelectItem key={type.value} value={type.value}>
                      {type.value !== 'all' ? (ENTITY_LABELS[type.value] || type.label) : "الكل"}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
                      ...
                      >
                        ...
                        <TableCell className="py-4 px-4">
                          <span className={cn(
                            ...
                            {ACTION_LABELS[log.actionType.toUpperCase()] || log.actionType}
                          </span>
                        </TableCell>
                        <TableCell className="py-4 px-4">
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="flex items-center gap-4">
                <div className="px-4 py-2 rounded-lg bg-neutral-100 border border-neutral-200">
                  <div className="text-xs text-neutral-500">الإجراء</div>
                  <div className={cn(
                    "text-sm font-bold uppercase",
                    getActionBadgeStyle(selectedLog.actionType)
                  )}>
                    {ACTION_LABELS[selectedLog.actionType.toUpperCase()] || selectedLog.actionType}
                  </div>
                </div>
                <div className="px-4 py-2 rounded-lg bg-neutral-100 border border-neutral-200">
                  <div className="text-xs text-neutral-500">الكيان المتأثر</div>
                  <div className="text-sm font-bold text-neutral-800">
                    {ENTITY_LABELS[selectedLog.entityName] || selectedLog.entityName}
                  </div>
                </div>
                <div className="px-4 py-2 rounded-lg bg-neutral-100 border border-neutral-200 flex-1">
                  <div className="text-xs text-neutral-500">رقم الكيان</div>
              ...
              <div>
                <div className="text-sm font-bold text-neutral-800 mb-3 flex items-center gap-2">
                  ...
                  التغييرات المنفذة ({changesCount})
                </div>
