    ...
    <div className="space-y-12 py-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
        <div className="space-y-2">
           <Link href={`/${locale}/queue`} className="inline-flex items-center gap-2 text-primary-500 font-black mb-4 hover:translate-x-[-4px] transition-all uppercase tracking-widest text-xs">
