...
const dashboardLinks: DashboardLink[] = [
  ...
  { href: '/employee/manager/reports', label: 'التقارير', icon: BarChart3, description: 'إحصائيات وتقارير شاملة' },
  { href: '/employee/manager/users', label: 'إدارة الموظفين', icon: Users, description: 'إدارة حسابات الموظفين' },
  { href: '/employee/manager/attendance', label: 'الحضور والانصراف', icon: Timer, description: 'سجلات الحضور والانصراف' },
