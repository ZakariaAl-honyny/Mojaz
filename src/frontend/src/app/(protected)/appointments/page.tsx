...
export default function AppointmentsPage() {
  ...
  const mockAppointments: AppointmentDto[] = [
    { id: '1', applicationId: 'a1', applicationNumber: 'MOJ-2026-11000001', appointmentType: 0, branchId: 'b1', branchName: 'مركز تعليم القيادة المركزي', scheduledDate: '2026-05-05', timeSlot: '09:00', status: 'Scheduled', createdAt: '', updatedAt: '' },
    { id: '2', applicationId: 'a2', applicationNumber: 'MOJ-2026-11000002', appointmentType: 1, branchId: 'b2', branchName: 'مركز الاختبارات النظري', scheduledDate: '2026-05-12', timeSlot: '10:00', status: 'Scheduled', createdAt: '', updatedAt: '' }
  ];
