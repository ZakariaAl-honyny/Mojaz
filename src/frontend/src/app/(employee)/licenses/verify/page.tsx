    ...
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-6">
      ...
      <Card className="border-0 shadow-lg">
        <CardContent className="p-6">
          ...
          {scanning && (
            <div className="mt-4 p-8 bg-neutral-800 rounded-xl text-center">
      ...
      {/* Search Result */}
      {searchResult && (
        <Card className={`border-0 shadow-lg overflow-hidden ${searchResult.status === 'valid'
            ? 'bg-gradient-to-br from-primary-50 to-white'
            : 'bg-gradient-to-br from-red-50 to-white'
          }`}>
          <div className={`p-4 text-white text-center ${searchResult.status === 'valid'
              ? 'bg-primary-500'
              : 'bg-red-500'
            }`}>
            ...
            <div className="space-y-3">
              {verificationHistory.map((item) => (
                ...
                >
                  ...
                  <Badge className={item.result === 'valid' ? 'bg-primary-100 text-primary-800' : 'bg-red-100 text-red-800'}>
