...
export default function LicenseIssuancePage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'ready':
        return <Badge className="bg-primary-100 text-primary-800">{t('employee.issue.ready')}</Badge>;
      case 'pending':
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-0 shadow-sm bg-gradient-to-br from-white to-primary-50/50">
