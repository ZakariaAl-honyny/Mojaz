...
export default async function TrainingPage({ params }: TrainingPageProps) {
  ...
  try {
    ...
    trainingRecord = {
      ...
      centerName: "Sana'a Central Branch",
  ...
  return (
    <div className="container mx-auto py-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-neutral-100 pb-6">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 text-neutral-50 tracking-tight">
            {t('title')}
          </h1>
          <p className="text-neutral-500 mt-1">{t('subtitle')}</p>
        </div>
        <div className="flex items-center gap-3 bg-neutral-50 bg-neutral-800 px-4 py-2 rounded-lg border border-neutral-100">
