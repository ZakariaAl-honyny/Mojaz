...
export default function UsersPage() {
  ...
  // Fetch data using useEffect pattern
  useEffect(() => {
    let isMounted = true;
        ...
        <Card className="border-none shadow-xl rounded-[2.5rem] bg-white p-8">
           <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-400 font-bold mt-2">كفاءة التفعيل</p>
              </div>
           </div>
        </Card>
      </div>
              ...
              <table className="w-full text-right border-collapse">
                <thead className="bg-neutral-50/50 border-b border-neutral-100">
                  <tr>
                    ...
                    <th className="px-10 py-6 text-[10px] font-black text-neutral-400 uppercase tracking-[0.2em] text-left">إجراءات</th>
                  </tr>
                </thead>
