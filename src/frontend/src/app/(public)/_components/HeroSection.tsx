...
import { ArrowRight, ChevronRight, ShieldCheck, Globe, UserCheck } from "lucide-react";
...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#1E3A8A] pt-16">
        ...
        <div className="max-w-4xl mx-auto text-center lg:text-start flex flex-col lg:flex-row items-center gap-12">
          ...
          <ScrollReveal direction="right" className="hidden lg:block flex-1 relative h-[500px]">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              {/* Smaller floating element - Verification Badge */}
              <motion.div
                animate={{
                  y: [-10, 10, -10],
                  x: [10, -10, 10]
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] transform translate-y-[1px]">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[60px] fill-neutral-50 fill-neutral-950">
