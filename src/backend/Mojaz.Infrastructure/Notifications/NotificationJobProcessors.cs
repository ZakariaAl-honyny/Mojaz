...
namespace Mojaz.Infrastructure.Notifications
{
    ...
    public class PushJobProcessor : NotificationJobProcessor
    {
        ...
        /// </summary>
        public static string Enqueue(int userId, string titleAr, string titleEn, string bodyAr, string bodyEn, string? data = null)
        {
            return BackgroundJob.Enqueue<PushJobProcessor>(processor => 
                processor.ExecuteAsync(userId, titleAr, titleEn, bodyAr, bodyEn, data));
        }

        public async Task ExecuteAsync(int userId, string titleAr, string titleEn, string bodyAr, string bodyEn, string? data = null)
        {
