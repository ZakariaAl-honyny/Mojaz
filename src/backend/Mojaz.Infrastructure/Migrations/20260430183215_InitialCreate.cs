        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionType = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ActionCategory = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppRole = table.Column<byte>(type: "tinyint", nullable: true),
                    ...
                    ApplicantType = table.Column<byte>(type: "tinyint", maxLength: 30, nullable: true),
                    ...
                    RegistrationMethod = table.Column<byte>(type: "tinyint", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalDecisionBy = table.Column<int>(type: "int", nullable: true),
                    ...
                    SecurityStatus = table.Column<byte>(type: "tinyint", nullable: false),
                    SecurityVerifiedBy = table.Column<int>(type: "int", nullable: true),
                    SecurityVerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseId = table.Column<int>(type: "int", nullable: false),
                    ApplicationId = table.Column<int>(type: "int", nullable: false),
                    Reason = table.Column<byte>(type: "tinyint", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingStatus = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
                    ...
                    ExemptionDocumentId = table.Column<int>(type: "int", nullable: true),
                    ExemptionApprovedBy = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, (byte)0, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(46), null, true, 16, "دراجة نارية", "Motorcycle", true, null, null, 0 },
                    { 2, (byte)1, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(55), null, true, 18, "خصوصي", "Private", true, null, null, 0 },
                    { 3, (byte)2, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(57), null, true, 21, "نقل عام", "Public Transport", true, null, null, 0 },
                    { 4, (byte)3, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(59), null, true, 21, "مركبات ثقيلة", "Heavy Vehicles", true, null, null, 0 },
                    { 5, (byte)4, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(62), null, true, 21, "مركبات صناعية", "Industrial Vehicles", true, null, null, 0 },
                    { 6, (byte)5, new DateTime(2026, 4, 30, 18, 32, 12, 673, DateTimeKind.Utc).AddTicks(64), null, true, 18, "مركبات زراعية", "Agricultural Vehicles", true, null, null, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "OTP", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(1913), null, "OTP validity in minutes for SMS", false, "OTP_VALIDITY_MINUTES_SMS", "5", null, null },
                    { 2, "OTP", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(1927), null, "OTP validity in minutes for Email", false, "OTP_VALIDITY_MINUTES_EMAIL", "15", null, null },
                    { 3, "OTP", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(1931), null, "Max OTP verification attempts", false, "OTP_MAX_ATTEMPTS", "3", null, null },
                    { 4, "OTP", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(1932), null, "Cooldown in seconds before resending OTP", false, "OTP_RESEND_COOLDOWN_SECONDS", "60", null, null },
                    { 5, "OTP", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(1934), null, "Max OTP resends per hour", false, "OTP_MAX_RESEND_PER_HOUR", "3", null, null },
                    { 11, "Email", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2029), null, "Deduplication window in seconds for outgoing emails", false, "EMAIL_DEDUP_WINDOW_SECONDS", "300", null, null },
                    { 12, "Email", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2032), null, "Maximum retry attempts for failed emails", false, "EMAIL_MAX_RETRIES", "3", null, null },
                    { 13, "Email", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2034), null, "Base delay in seconds for email retry exponential backoff", false, "EMAIL_RETRY_BASE_DELAY_SECONDS", "60", null, null },
                    { 21, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2050), null, "Maximum number of times an applicant can reschedule an appointment", false, "MAX_RESCHEDULE_COUNT", "3", null, null },
                    { 22, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2052), null, "Default duration of an appointment slot in minutes", false, "DEFAULT_APPOINTMENT_DURATION_MINUTES", "30", null, null },
                    { 23, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2061), null, "Maximum number of appointments allowed per time slot per branch", false, "MAX_APPOINTMENTS_PER_SLOT", "2", null, null },
                    { 24, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2063), null, "Buffer time between appointments in minutes", false, "SLOT_BUFFER_MINUTES", "15", null, null },
                    { 25, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2065), null, "Start of working hours for appointments (24-hour format)", false, "WORKING_HOURS_START", "08:00", null, null },
                    { 26, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2067), null, "End of working hours for appointments (24-hour format)", false, "WORKING_HOURS_END", "16:00", null, null },
                    { 27, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2069), null, "Hours before appointment to send reminder notification", false, "REMINDER_HOURS_BEFORE", "24", null, null },
                    { 28, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2071), null, "Minimum days in advance an appointment must be booked", false, "MIN_BOOKING_DAYS_AHEAD", "1", null, null },
                    { 29, "Appointment", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2073), null, "Maximum days in advance an appointment can be booked", false, "MAX_BOOKING_DAYS_AHEAD", "30", null, null },
                    { 31, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2094), null, "Minimum training hours for Category A (Motorcycle)", false, "MIN_TRAINING_HOURS_CATEGORY_A", "8", null, null },
                    { 32, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2196), null, "Minimum training hours for Category B (Private)", false, "MIN_TRAINING_HOURS_CATEGORY_B", "20", null, null },
                    { 33, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2198), null, "Minimum training hours for Category C (Public Transport)", false, "MIN_TRAINING_HOURS_CATEGORY_C", "30", null, null },
                    { 34, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2201), null, "Minimum training hours for Category D (Heavy Vehicles)", false, "MIN_TRAINING_HOURS_CATEGORY_D", "40", null, null },
                    { 35, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2203), null, "Minimum training hours for Category E (Industrial)", false, "MIN_TRAINING_HOURS_CATEGORY_E", "40", null, null },
                    { 36, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2205), null, "Minimum training hours for Category F (Agricultural)", false, "MIN_TRAINING_HOURS_CATEGORY_F", "20", null, null },
                    { 37, "Training", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2248), null, "Minimum age for Category F (Agricultural)", false, "MIN_AGE_CATEGORY_F", "18", null, null },
                    { 41, "Theory", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2271), null, "Minimum passing score for theory test", false, "MIN_PASS_SCORE_THEORY", "80", null, null },
                    { 42, "Theory", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2273), null, "Number of theory test questions for Category F (Agricultural)", false, "THEORY_QUESTIONS_CATEGORY_F", "20", null, null },
                    { 51, "Practical", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2285), null, "Minimum passing score for practical test", false, "MIN_PASS_SCORE_PRACTICAL", "80", null, null },
                    { 52, "Practical", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2287), null, "Maximum number of practical test attempts", false, "MAX_PRACTICAL_ATTEMPTS", "3", null, null },
                    { 53, "Practical", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2289), null, "Days applicant must wait before rebooking after practical test failure", false, "COOLING_PERIOD_DAYS_PRACTICAL", "7", null, null },
                    { 61, "License", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2299), null, "License validity in years for Category F (Agricultural)", false, "VALIDITY_YEARS_CATEGORY_F", "10", null, null },
                    { 71, "Upgrade", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2305), null, "Minimum months a license must be held before upgrading", false, "MIN_HOLDING_PERIOD_UPGRADE_MONTHS", "12", null, null },
                    { 72, "Upgrade", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2307), null, "Allowed category upgrade paths (Format: FROM-TO, separated by comma)", false, "ALLOWED_UPGRADE_PATHS", "B-C,B-D,B-E,C-D,C-E,D-E,F-B", null, null },
                    { 73, "Upgrade", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2313), null, "Percentage reduction in training hours for category upgrades", false, "UPGRADE_TRAINING_REDUCTION_PCNT", "50", null, null },
                    { 81, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2331), null, "Retention period for Audit Logs in days", false, "SECURITY_LOG_RETENTION_DAYS", "90", null, null },
                    { 82, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2333), null, "Number of permits for authentication endpoints per window", false, "RATE_LIMIT_AUTH_PERMIT", "10", null, null },
                    { 83, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2335), null, "Time window in seconds for authentication rate limiting", false, "RATE_LIMIT_AUTH_WINDOW", "60", null, null },
                    { 84, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2337), null, "Number of permits for global API endpoints per window", false, "RATE_LIMIT_GLOBAL_PERMIT", "100", null, null },
                    { 85, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2339), null, "Time window in seconds for global rate limiting", false, "RATE_LIMIT_GLOBAL_WINDOW", "60", null, null },
                    { 86, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2341), null, "Maximum allowed file size for uploads in bytes (Default 5MB)", false, "MAX_FILE_SIZE_BYTES", "5242880", null, null },
                    { 87, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2346), null, "Number of failed login attempts before sending security alert", false, "SECURITY_ALERT_THRESHOLD", "5", null, null },
                    { 88, "Security", new DateTime(2026, 4, 30, 18, 32, 12, 690, DateTimeKind.Utc).AddTicks(2348), null, "Time window in minutes for security alert threshold", false, "SECURITY_ALERT_WINDOW_MINS", "10", null, null }
                });
