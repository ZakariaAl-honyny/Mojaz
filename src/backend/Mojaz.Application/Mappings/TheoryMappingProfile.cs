    ...
    public class TheoryMappingProfile : Profile
    {
        public TheoryMappingProfile()
        {
            CreateMap<TheoryTest, TheoryTestDto>()
                ...
                .ForMember(dest => dest.ExaminerName, opt => opt.MapFrom(src => src.Examiner != null ? src.Examiner.FullNameEn : null))
                .ForMember(dest => dest.ApplicationStatus, opt => opt.MapFrom(src => src.Application != null ? src.Application.Status.ToString() : null));
        }
    }
}
