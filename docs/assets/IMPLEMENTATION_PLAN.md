...
│   ├── [x] Setup Tailwind with DrivingLicenseIssuanceSystem theme colors
...
│   ├── [x] Create DbContext (DrivingLicenseIssuanceSystemDbContext)
...
│   │   ├── [x] Completed stages: King blue checkmark
